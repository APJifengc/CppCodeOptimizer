...
public class TClass extends TElement {
    ...
    private br.com.criativasoft.cpluslibparser.metadata.TClass parent;
    ...
    public br.com.criativasoft.cpluslibparser.metadata.TClass getParent() {
        return parent;
    }

    public void setParent(br.com.criativasoft.cpluslibparser.metadata.TClass parent) {
        this.parent = parent;
    }
