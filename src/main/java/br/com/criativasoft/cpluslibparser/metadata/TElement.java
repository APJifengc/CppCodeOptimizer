...
public class TElement implements Serializable {
    ...
    public static boolean contains(int offset, Collection<? extends br.com.criativasoft.cpluslibparser.metadata.TElement> list) {
        for (br.com.criativasoft.cpluslibparser.metadata.TElement el : list) {
