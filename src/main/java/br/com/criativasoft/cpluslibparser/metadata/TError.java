...
public class TError extends TElement {
    ...
    public static boolean containsError(int offset, Collection<br.com.criativasoft.cpluslibparser.metadata.TError> errors) {
        for (br.com.criativasoft.cpluslibparser.metadata.TError error : errors) {
